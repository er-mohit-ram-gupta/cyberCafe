...
if ( ! class_exists( 'Classic_Internet_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Classic_Internet_Services_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Classic_Internet_Services_WPTT_WebFont_Loader( $url );
