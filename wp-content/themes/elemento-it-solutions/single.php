  ...
  <div class="container">
    <?php if ( get_theme_mod('elemento_it_solutions_header_page_title' , true)) : ?>
        ...
        <div class="headerimgbox-meta">
          ...
          <?php endwhile; ?>
          <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number( esc_attr('0', 'elemento-it-solutions'), esc_attr('0', 'elemento-it-solutions'), esc_attr('%', 'elemento-it-solutions') ); ?> <?php esc_html_e('comments','elemento-it-solutions'); ?></span>
        </div>
    <?php endif; ?>
