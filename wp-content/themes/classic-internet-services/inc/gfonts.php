...
function classic_internet_services_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'classic-internet-services-basic-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'classic_internet_services_custom_styles' );

//Sanitizes Fonts
function classic_internet_services_sanitize_fonts( $input ) {
	$valid = array(
		'Kaushan Script:' => 'Hind:wght@300;400;500;600;700',
